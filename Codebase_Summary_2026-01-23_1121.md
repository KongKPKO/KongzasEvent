# Source Code Summary
Generated on Fri Jan 23 11:19:53 +07 2026
...
## src/pages/creators/SupabaseDashboard.tsx
```tsx
import { useEffect, useState } from 'react';
import { supabase } from '../../supabaseClient';
import { RealtimeChannel } from '@supabase/supabase-js';
...
import { Loader, Trash2, Upload, Plus, FileText, Edit2, X, LayoutDashboard, List, History } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-20">
         ...
         <nav className="bg-white border-b border-gray-200 sticky top-0 z-10 px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between shadow-sm">
            ...
            <div className="flex items-center gap-6">
               ...
               <Link to="/artist/manage-events" className="text-gray-500 hover:text-pink-500 transition-colors flex flex-col items-center text-xs font-medium gap-1">
                  <LayoutDashboard size={20} />
                  <span>Home</span>
               </Link>
               ...
               <Link to="/artist/manage-queues" className="text-gray-500 hover:text-pink-500 transition-colors flex flex-col items-center text-xs font-medium gap-1">
                  <History size={20} />
                  <span>Queue</span>
               </Link>
               <div className="h-6 w-px bg-gray-200 mx-2"></div>
         ...
         <div className="max-w-5xl mx-auto px-6 pt-2 mb-2">
            <h1 className="text-xl font-black text-gray-800 tracking-tight">Manage Menu</h1>
         </div>
                  ...
                  <div className="space-y-1">
                     ...
                     <div className="relative">
                        ...
                        >
                           ...
                           <span className="truncate text-xs font-medium">{file ? file.name : 'Choose Image'}</span>
                        </label>
                     </div>
                  </div>
...
const SupabaseLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // On success, the parent App component (AppSupabase) listening to onAuthStateChange will handle the redirect/state change.
    setLoading(false);
  };
