...
export default function POSPanel({
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="hidden md:block bg-white border-b border-gray-200 shrink-0 shadow-sm">
            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-h-0">
                ...
                <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-gray-50/50 order-1 md:order-2">
                    <div className="bg-white px-3 py-2 md:px-4 md:py-3 border-b border-gray-100 shadow-sm shrink-0 space-y-1.5 md:space-y-2">
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className="min-h-9 flex-1 rounded-lg border border-gray-200 px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 md:py-2"
                                aria-label="Search products"
                            />
                            <select
                                value={sortBy}
                                onChange={(e) => setSortBy(e.target.value as SortType)}
                                className="min-h-9 w-[96px] cursor-pointer rounded-lg border border-gray-200 bg-white px-2 py-1.5 text-sm font-bold md:w-auto md:px-3 md:py-2"
                            ...
                            {quickFilters.map((filter) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-2.5 py-1 md:px-3 md:py-1.5 rounded-full text-[11px] md:text-xs font-semibold transition-all whitespace-nowrap inline-flex items-center gap-1.5 ${filter.id === 'recent' || filter.id === 'pinned' ? 'hidden md:inline-flex' : ''} ${selectedQuickFilter === filter.id ? 'bg-gray-900 text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                                    >
                                        <Icon size={12} />
                        ...
                        <div className="flex gap-1.5 overflow-x-auto no-scrollbar">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`px-2.5 py-1 rounded-full text-[11px] md:px-3 md:text-xs font-semibold transition-all whitespace-nowrap ${selectedCategory === cat.label ? 'bg-pink-600 text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                                >
                            ...
                            <div className="flex gap-1.5 overflow-x-auto no-scrollbar">
                                {tags.map((tag) => (
                                    <button
                                        ...
                                        className={`px-2.5 py-1 rounded-full text-[11px] md:px-3 md:text-xs font-semibold transition-all whitespace-nowrap ${selectedTag === tag.label ? 'bg-sky-600 text-white shadow-md' : 'bg-sky-50 text-sky-700 hover:bg-sky-100'}`}
                                    >
                                ...
                                {filteredProducts.map((product) => (
                                    (() => {
                                        ...
                                        return (
                                                ...
                                                >
                                                    <div className="w-full aspect-[5/2] md:aspect-[4/3] bg-gray-100 relative overflow-hidden shrink-0">
                                                        {product.image_url ? (
                                                            <img
                                                                src={getProductImage(product.image_url)}
                                                                alt={product.name}
                                                    ...
                                                    <div className="flex flex-col px-2 pb-1.5 pt-1.5 md:px-3 md:pb-3 md:pt-2.5 justify-between flex-1 min-w-0">
                                                        ...
                                                        <div className="mt-0.5 md:mt-3 flex items-end justify-between gap-2">
                                                            ...
                                                            <div className="text-[13px] md:text-base font-black text-pink-600">
