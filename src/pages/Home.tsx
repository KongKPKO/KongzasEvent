    ...
    <div className="min-h-screen bg-white w-full max-w-md mx-auto flex flex-col pb-20">
      ...
      <div className="flex-1 px-5 mt-4">
        ...
        <div className="space-y-4">
           ...
           {/* Event 2: Japan Expo */}
           <Card className="border-none shadow-sm bg-gray-50/50 p-5 rounded-2xl relative overflow-hidden ring-1 ring-gray-100 opacity-90 grayscale-[0.3] hover:grayscale-0 transition-all">
               <div className="flex items-start gap-4">
                 {/* Date Box */}
                 <div className="w-16 h-16 bg-white rounded-2xl flex flex-col items-center justify-center border border-gray-100 shrink-0">
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">JAN</span>
