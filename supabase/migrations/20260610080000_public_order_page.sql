-- Public order page: look up a preorder by artist slug + pickup code alone,
-- returning everything the customer-facing order page needs (items, payment
-- state, reject reason, payment methods) with contact details masked.
